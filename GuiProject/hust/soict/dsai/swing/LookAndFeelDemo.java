...
public class LookAndFeelDemo extends JFrame {
	...
	void addLookAndFeelComboBox() {
		...
		//lafNames[lafInfos.length] = UIManager.getCrossPlatformLookAndFeelClassName();
		//lafNames[lafInfos.length + 1] = UIManager.getSystemLookAndFeelClassName();
		//Two options above are already added to lafInfos via UIManager.getInstalledLookAndFeels()
